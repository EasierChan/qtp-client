        ...
        for (; bufCount < this._oPool.length; ++bufCount) {
            ...
            if (buflen >= this._curHeader.datalen + message_model_1.Header.len) {
                ...
                try {
                    ...
                    restLen = buflen - message_model_1.Header.len - this._curHeader.datalen;
                    if (restLen > 0) {
...
var QtpService = (function () {
    ...
    QtpService.prototype.send = function (msgtype, body, service, topic) {
        var msg = new message_model_1.QTPMessage();
    ...
    QtpService.prototype.sendWithOption = function (msgtype, options, body, service, topic) {
        var msg = new message_model_1.QTPMessage();
        msg.header.msgtype = msgtype;
    ...
    QtpService.prototype.subscribe = function (topic, keys) {
        var msg = new message_model_1.QTPMessage();
        msg.header.msgtype = message_model_1.FGS_MSG.kSubscribe;
        msg.header.topic = topic;
