...
var BasketPCF = (function () {
    function BasketPCF() {
        this.params = {};
        this.components = [];
    }
    BasketPCF.prototype.toText = function () {
        var text = "[Parameters]\n";
        ...
        this.components.forEach(function (item) {
            ...
            if (item.rep_codes) {
                item.rep_codes.forEach(function (rep) {
...
var BufferUtil = (function () {
    ...
    BufferUtil.format = function (buf, offset, fmt, msg) {
        ...
        var marr = fmt.match(/\d+[bBwWiIlLspfdo]/g);
        var len = 0;
        var iprop = 0;
