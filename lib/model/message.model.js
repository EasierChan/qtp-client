...
var QtpMessageOption = (function () {
    ...
    QtpMessageOption.prototype.fromBuffer = function (buf, offset) {
        ...
        offset += 2;
        this.value = buf.slice(offset, offset + this.len);
        offset += this.len;
        return offset;
    };
...
(function (ServiceType) {
    ...
    ServiceType[ServiceType["kLogin"] = 10] = "kLogin";
    ServiceType[ServiceType["kStrategy"] = 20] = "kStrategy";
    ServiceType[ServiceType["kSSGW"] = 21] = "kSSGW";
    ServiceType[ServiceType["kCOMS"] = 30] = "kCOMS";
    ServiceType[ServiceType["kCMS"] = 40] = "kCMS";
    ServiceType[ServiceType["kSDS"] = 50] = "kSDS";
    ServiceType[ServiceType["kBackServer"] = 60] = "kBackServer";
    ServiceType[ServiceType["kSimServer"] = 61] = "kSimServer";
